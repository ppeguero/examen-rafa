  ...
  <header>
    ...
    <div className="navbar navbar-dark  shadow-sm bg-green-800">
      <div className="container d-flex justify-content-between">
        ...
        >
        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-plant" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
          ...
          <strong className='font-BebasNue'>Plant Care</strong>
        </a>
        <button
